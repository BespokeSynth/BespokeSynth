...
#include "Instruments/LaunchpadKeyboard.h"
#include "Scale.h"
#include "Synths/DrumPlayer.h"
#include "AudioEffects/EffectChain.h"
#include "AudioEffects/LooperRecorder.h"
#include "NoteEffects/Chorder.h"
#include "Transport.h"
#include "NoteEffects/Arpeggiator.h"
#include "Synths/Razor.h"
#include "NoteEffects/Monophonify.h"
#include "Instruments/StepSequencer.h"
#include "AudioEffects/InputChannel.h"
#include "AudioEffects/OutputChannel.h"
#include "AudioEffects/WaveformViewer.h"
#include "Synths/FMSynth.h"
#include "Instruments/MidiController.h"
#include "PSMoveController.h"
#include "AudioEffects/Autotalent.h"
#include "NoteEffects/ScaleDetect.h"
#include "Synths/KarplusStrong.h"
#include "NoteEffects/WhiteKeys.h"
#include "NoteEffects/Kicker.h"
#include "AudioEffects/RingModulator.h"
#include "NoteEffects/Neighborhooder.h"
#include "Instruments/Polyrhythms.h"
#include "AudioEffects/Looper.h"
#include "AudioEffects/Rewriter.h"
#include "Synths/Metronome.h"
#include "NoteEffects/NoteRouter.h"
#include "Instruments/NoteLooper.h"
#include "AudioEffects/AudioRouter.h"
#include "NoteEffects/LaunchpadNoteDisplayer.h"
#include "AudioEffects/Vocoder.h"
#include "AudioEffects/VocoderCarrierInput.h"
#include "AudioEffects/FreqDomainBoilerplate.h"
#include "AudioEffects/FFTtoAdditive.h"
#include "AudioEffects/FreqDelay.h"
#include "NoteEffects/VelocitySetter.h"
#include "Instruments/NoteSinger.h"
#include "NoteEffects/NoteOctaver.h"
#include "AudioEffects/SampleFinder.h"
#include "Instruments/FourOnTheFloor.h"
#include "AudioEffects/Amplifier.h"
#include "Presets.h"
#include "LFOController.h"
#include "Instruments/NoteStepSequencer.h"
#include "Synths/BeatBloks.h"
#include "AudioEffects/Producer.h"
#include "ChaosEngine.h"
#include "Synths/SingleOscillator.h"
#include "AudioEffects/BandVocoder.h"
#include "NoteEffects/Capo.h"
#include "Synths/ControlTactileFeedback.h"
//#include "Synths/Eigenharp.h"
#include "Synths/Beats.h"
#include "Synths/Sampler.h"
#include "NoteEffects/NoteTransformer.h"
#include "Instruments/SliderSequencer.h"
#include "AudioEffects/MultibandCompressor.h"
#include "Synths/ControllingSong.h"
#include "PanicButton.h"
#include "NoteEffects/VelocityStepSequencer.h"
#include "NoteEffects/SustainPedal.h"
#include "MultitrackRecorder.h"
//#include "NoteEffects/MidiPlayer.h"
#include "AudioEffects/SamplerGrid.h"
#include "Synths/SignalGenerator.h"
#include "AudioEffects/Lissajous.h"
#include "Synths/DebugAudioSource.h"
#include "TimerDisplay.h"
#include "Synths/DrumSynth.h"
//#include "NoteEffects/EigenChorder.h"
#include "NoteEffects/PitchBender.h"
//#include "NoteEffects/EigenharpNoteSource.h"
#include "Synths/FollowingSong.h"
#include "Synths/SeaOfGrain.h"
#include "Modulators/VinylTempoControl.h"
#include "NoteEffects/NoteFlusher.h"
#include "FilterViz.h"
#include "Instruments/NoteCanvas.h"
#include "AudioEffects/SlowLayers.h"
#include "Synths/ClipLauncher.h"
#include "LoopStorer.h"
#include "CommentDisplay.h"
#include "ComboGridController.h"
#include "AudioEffects/StutterControl.h"
#include "Instruments/CircleSequencer.h"
#ifdef BESPOKE_MAC
#include "NoteEffects/KompleteKontrol.h"
#endif
#include "MidiOutput.h"
#include "Modulators/FloatSliderLFOControl.h"
#include "NoteEffects/NoteDisplayer.h"
#include "AudioEffects/AudioMeter.h"
#include "NoteEffects/NoteSustain.h"
#include "AudioEffects/PitchChorus.h"
#include "Synths/SampleCanvas.h"
#include "Modulators/ControlSequencer.h"
#include "NoteEffects/PitchSetter.h"
#include "NoteEffects/NoteFilter.h"
#include "Instruments/RandomNoteGenerator.h"
#include "Modulators/NoteToFreq.h"
#include "Modulators/MacroSlider.h"
#include "NoteEffects/NoteVibrato.h"
#include "NoteEffects/ModulationVisualizer.h"
#include "NoteEffects/PitchDive.h"
#include "EventCanvas.h"
#include "Instruments/NoteCreator.h"
#include "Modulators/ValueSetter.h"
#include "NoteEffects/PreviousNote.h"
#include "NoteEffects/PressureToVibrato.h"
#include "NoteEffects/ModwheelToVibrato.h"
#include "NoteEffects/Pressure.h"
#include "NoteEffects/ModWheel.h"
#include "NoteEffects/PressureToModwheel.h"
#include "NoteEffects/ModwheelToPressure.h"
#include "Synths/VSTPlugin.h"
#include "AudioEffects/FeedbackModule.h"
#include "Modulators/NoteToMs.h"
#include "Selector.h"
#include "GroupControl.h"
#include "Modulators/CurveLooper.h"
#include "NoteEffects/ScaleDegree.h"
#include "Instruments/NoteChainNode.h"
#include "NoteEffects/NoteDelayer.h"
#include "TimelineControl.h"
#include "NoteEffects/VelocityScaler.h"
#include "Instruments/KeyboardDisplay.h"
#include "Modulators/Ramper.h"
#include "NoteEffects/NoteGate.h"
#include "Prefab.h"
#include "NoteEffects/NoteHumanizer.h"
#include "NoteEffects/VolcaBeatsControl.h"
#include "RadioSequencer.h"
#include "AudioEffects/TakeRecorder.h"
#include "AudioEffects/Splitter.h"
#include "AudioEffects/Panner.h"
#include "Synths/SamplePlayer.h"
#include "AudioEffects/AudioSend.h"
#include "EnvelopeEditor.h"
#include "Modulators/EnvelopeModulator.h"
#include "Modulators/AudioToCV.h"
#include "Modulators/ModulatorAdd.h"
#include "Modulators/ModulatorAddCentered.h"
#include "Modulators/PitchToCV.h"
#include "Modulators/VelocityToCV.h"
#include "Modulators/PressureToCV.h"
#include "Modulators/ModWheelToCV.h"
#include "Modulators/ModulatorMult.h"
#include "Modulators/ModulatorCurve.h"
#include "Modulators/ModulatorSmoother.h"
#include "NoteEffects/NotePanner.h"
#include "NoteEffects/PitchPanner.h"
#include "NoteEffects/NotePanAlternator.h"
#include "NoteEffects/ChordDisplayer.h"
#include "NoteEffects/NoteStrummer.h"
#include "Modulators/PitchToSpeed.h"
#include "Pulse/NoteToPulse.h"
#include "OSCOutput.h"
#include "Modulators/AudioLevelToCV.h"
#include "Pulse/Pulser.h"
#include "Pulse/PulseSequence.h"
#include "NoteEffects/LinnstrumentControl.h"
#include "AudioEffects/MultitapDelay.h"
#include "NoteEffects/MidiCapturer.h"
#include "AudioEffects/Inverter.h"
#include "AudioEffects/SpectralDisplay.h"
#include "AudioEffects/DCOffset.h"
#include "AudioEffects/SignalClamp.h"
#include "AudioEffects/Waveshaper.h"
#include "Modulators/ModulatorSubtract.h"
#include "NoteEffects/NoteHocket.h"
#include "NoteEffects/NoteRangeFilter.h"
#include "NoteEffects/NoteChance.h"
#include "Pulse/PulseChance.h"
#include "Pulse/PulseDelayer.h"
#include "NoteEffects/NotePanRandom.h"
#include "Pulse/PulseGate.h"
#include "Pulse/PulseHocket.h"
#include "Push2Control.h"
#include "Pulse/PulseTrain.h"
#include "NoteEffects/NoteLatch.h"
#include "ScriptModule.h"
#include "ScriptStatus.h"
#include "Modulators/ModulatorGravity.h"
#include "NoteEffects/NoteStreamDisplay.h"
#include "Pulse/PulseButton.h"
#include "GridModule.h"
#include "Modulators/FubbleModule.h"
#include "GlobalControls.h"
#include "ValueStream.h"
#include "AudioEffects/EQModule.h"
#include "AudioEffects/SampleCapturer.h"
#include "NoteEffects/NoteQuantizer.h"
#include "Instruments/PlaySequencer.h"
#include "NoteEffects/UnstablePitch.h"
#include "NoteEffects/UnstableModWheel.h"
#include "NoteEffects/UnstablePressure.h"
#include "NoteEffects/ChordHolder.h"
#include "LooperGranulator.h"
#include "Pulse/AudioToPulse.h"
#include "Instruments/NoteCounter.h"
#include "NoteEffects/PitchRemap.h"
#include "Modulators/ModulatorExpression.h"
#include "SampleBrowser.h"
#include "NoteEffects/TransposeFrom.h"
#include "NoteEffects/NoteStepper.h"
#include "Instruments/M185Sequencer.h"
#include "Modulators/ModulatorAccum.h"
#include "Modulators/GridSliders.h"
#include "NoteEffects/NoteRatchet.h"
#include "NoteEffects/NoteSorter.h"
#include "NoteEffects/MPESmoother.h"
#include "NoteEffects/MidiControlChange.h"
#include "NoteEffects/MPETweaker.h"
#include "NoteEffects/NoteExpressionRouter.h"
#include "NoteToggle.h"
#include "NoteEffects/NoteTable.h"
#include "AbletonLink.h"
#include "MidiClockIn.h"
#include "MidiClockOut.h"
#include "NoteEffects/VelocityToChance.h"
#include "NoteEffects/NoteEcho.h"
#include "NoteEffects/VelocityCurve.h"
#include "Pulse/BoundsToPulse.h"
