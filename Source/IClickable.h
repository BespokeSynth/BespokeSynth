...
public:
   ...
   bool NotifyMouseScrolled(float x, float y, float scrollX, float scrollY, bool isSmoothScroll);
...
protected:
   ...
   virtual bool MouseScrolled(float x, float y, float scrollX, float scrollY, bool isSmoothScroll) { return false; }
