...
, mNumPartialsSlider(NULL)
, mBumpAmpSlider(NULL)
, mBumpAmpAmtSlider(NULL)
, mBumpAmpDecaySlider(NULL)
, mBumpAmpSlider2(NULL)
, mBumpAmpAmtSlider2(NULL)
, mBumpAmpDecaySlider2(NULL)
, mBumpAmpSlider3(NULL)
, mBumpAmpAmtSlider3(NULL)
, mBumpAmpDecaySlider3(NULL)
, mA(1)
, mD(0)
, mS(1)
, mR(1)
...
, mHistoryPtr(0)
, mHarmonicSelector(1)
, mHarmonicSelectorSlider(NULL)
, mPowFalloff(1)
, mPowFalloffSlider(NULL)
, mNegHarmonics(0)
, mNegHarmonicsSlider(NULL)
, mHarshnessCut(0)
, mHarshnessCutSlider(NULL)
, mManualControl(false)
, mManualControlCheckbox(NULL)
, mPitchBend(NULL)
, mModWheel(NULL)
, mPressure(NULL)
{
...
void Razor::Process(double time)
{
   ...
   for (int i=0; i<bufferSize; ++i)
   {
      ...
      for (int j=0; j<mUseNumPartials && j<oscNyquistLimitIdx; ++j)
      {
         ...
         mPhases[j] += phaseInc;
         while (mPhases[j] >= 512) { mPhases[j] -= 512; }
...
void Razor::PlayNote(double time, int pitch, int velocity, int voiceIdx /*= -1*/, ModulationChain* pitchBend /*= NULL*/, ModulationChain* modWheel /*= NULL*/, ModulationChain* pressure /*= NULL*/)
{
   if (!mEnabled)
      return;
