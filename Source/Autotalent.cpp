...
, mLfoampSlider(NULL)
, mLforateSlider(NULL)
, mLfoshapeSlider(NULL)
, mLfosymmSlider(NULL)
, mLfoquantCheckbox(NULL)
, mFcorrCheckbox(NULL)
, mFwarpSlider(NULL)
, mMixSlider(NULL)
, mSetFromScaleButton(NULL)
, mPitch(0)
, mConfidence(0)
{
...
void Autotalent::PlayNote(double time, int pitch, int velocity, int voiceIdx /*= -1*/, ModulationChain* pitchBend /*= NULL*/, ModulationChain* modWheel /*= NULL*/, ModulationChain* pressure /*= NULL*/)
{
   if (velocity > 0)
   {
      mC = (pitch % 12) == 0 ? 1 : -1;
