...
private:
   ...
   float mRndLengthMax{ 24 };
   FloatSlider* mRndLengthMaxSlider{ nullptr };
   float mRndOnsetChance{ 0.5f };
   FloatSlider* mRndOnsetChanceSlider{ nullptr };
   float mRndOnsetMax{ 12 };
   FloatSlider* mRndOnsetMaxSlider{ nullptr };
   float mRndRotationChance{ 0.5f };
   FloatSlider* mRndRotationChanceSlider{ nullptr };
   float mRndRotationMax{ 4 };
   FloatSlider* mRndRotationMaxSlider{ nullptr };
