...
"C:\Program Files (x86)\WiX Toolset v3.11\bin\light" BespokeSynth.wixobj HarvestedResourceDir.wixobj -b ..\Builds\MacOSX\build\Release\resource -out Bespoke-Windows.msi -ext WixUIExtension
